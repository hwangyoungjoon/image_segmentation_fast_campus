...
# 학습에 필요한 설정값들을 지정합니다.
data_dir = 'C:/Users/rhlfu/Desktop/study/영상 이미지 분석/3주차/data'
...
# 텍스트 로더를 이용해서 데이터를 불러옵니다.
data_loader= TextLoader(data_dir,batch_size,seq_length)
# 학습데이터에 포함된 모든 단어들을 나타내는 변수인 chars와 chars에 id를 부여해 dict형태로 만든 vocab를 만든다.
chars=data_loader.chars
vocab=data_loader.vocab
vocab_size=data_loader.vocab_size

# 인풋데이터와 타겟데이터, 배치 사이즈를 입력받기 위한 플레이스 홀더를 정합니다.
...
# RNN의 마지막 히든레이어의 출력을 소프트 맥스로 출력값을 위한 변수 선언
